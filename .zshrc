...
plugins=(git git-flow compleat zsh-autosuggestions zsh-completions k)
...
#PATHs
#apps no /usr/local/bin já estão no PATH por padrão.
#------------------------------IntelliJ
export PATH=$PATH:~/Apps/idea-22.2.3/bin
#----------------------------------JAVA
export JAVA_HOME="/usr/lib/jdk/jdk-11"
...
alias ld='exa -lbGF --git --icons'                                             # long list
alias ll='l -la'
